...
<?php if (isset($_SESSION['username'])): ?>
    ...
    <h1>Logged In</h1>
    <p class="alert alert-success">You have logged in successfully, <b><?php echo $_SESSION['username'] ?></b>. Please wait while you are being redirected.</p>
...
<?php else : ?>
    <div class="alert alert-block">
        ...
        <?php if (!$user->validation_errors['username']['length']
            ...
            <div>Wrong username or password.
            </div>        
        <?php endif ?>
    </div>
<?php endif ?>